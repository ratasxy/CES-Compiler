...
private:
    ...
    enum charType {
        ...
        sum_op=10, sub_op=11, mul_op=12, div_op=13, assignment_op=14, minus_op=15, mayus_op=16,
        quotation=50,
        not_valid=60,
        space=80, end_of_line=81,
        end_instruction=90,
        bracket_start = 101, bracket_end=102, parenthesis_start=103, parenthesis_end=104,
        variableName = 200, cif=201, celse=202, ifor = 203, iwhile=204, iteration=300, control=301, unary_op=302,
        dataType=303, point=304
    };
